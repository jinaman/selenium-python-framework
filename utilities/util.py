...
class Util(object):
    ...
    def getAlphaNumeric(self, length, type='letters'):            #Me provee un largo de caratcteres random, le paso el largo y el tipo.
        """
    ...
    def getUniqueName(self, charCount=10):         #Es para usar el anterior, pero con 10 letras en minusculas como valor predeterminado
        """
        Get a unique name
        """
        return self.getAlphaNumeric(charCount, 'lower')

    def getUniqueNameList(self, listSize=5, itemLength=None):     #Como la anterior, pero una lista de valores unicos.
        """
